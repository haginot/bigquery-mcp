...
# Install dependencies with mcp 1.6.0 fixed
...
# Use Poetry-generated console script as entrypoint
# mcp-bigquery-server is the console script generated by Poetry
ENTRYPOINT ["mcp-bigquery-server"]
